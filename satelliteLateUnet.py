...
def satellite_unet(input_shapes2,input_shapes1, num_classes=1,output_activation='sigmoid',num_layers=4, attention=0):
    inputs1 = Input(input_shapes1)
    inputs2 = Input(input_shapes2)
    x1=unetSingle(inputs2,num_layers, attention)
    x2=unetSingle(inputs1,num_layers, attention)
    x = concatenate([x1, x2])
...
def unetSingle(inputs, num_layers=4, attention=0):
